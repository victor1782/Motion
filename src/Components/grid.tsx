          ...
          <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
              ...
              <p
                className="text-left text-primary font-bold mt-2 max-w-lg text-2xl lg:text-4xl font-semibold tracking-tight text-balance">
                  Nombre Medio - Nombre del cliente
              </p>
              <div className="mt-8 pt-8 lg:pt-12 grid grid-cols-1 lg:grid-cols-3 lg:grid-rows-2 gap-4 border-t-2 border-gray-200">
                  ...
                  <div className="relative lg:col-span-2 max-lg:order-1">
                      ...
                      <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] lg:rounded-l-[calc(2rem+1px)] bg-teal-200">
                  ...
                  <div className="relative max-lg:order-2">
                      ...
                      <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)] bg-violet-200">
                  ...
                  <div className="relative max-lg:order-4">
                      ...
                      <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] bg-orange-200">
                          <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                  ...
                  <div className="relative lg:row-span-1 max-lg:order-3">
                      ...
                      <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)] bg-rose-200">
                          <div className="px-8 pt-8 pb-3 sm:px-10 sm:pt-10 sm:pb-0">
                              <p className="mt-2 text-lg font-medium tracking-tight text-gray-950 max-lg:text-center">
                                  Powerful APIs
                              </p>
