    ...
    return (
      <div className="bg-gray-50 py-24 sm:py-32">
          <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
              ...
              <div className="mt-8 pt-8 lg:pt-12 grid grid-cols-1 lg:grid-cols-3 gap-4 border-t-2 border-gray-200 lg:grid-rows-[auto_1fr]">
                  ...
                  <div className="relative lg:col-span-2 lg:row-span-2 max-lg:order-1 h-full">
                      ...
                      <div
                        className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] lg:rounded-l-[calc(2rem+1px)] bg-gray-200">
                          ...
                          <div className="@container pt-8 pb-8 px-6 grid place-items-center relative sm:px-10 w-full">
                              <video
                  ...
                  {/*Quinto elemento*/}
                  <div className="relative max-lg:order-5 h-full">
                      <div className="absolute"></div>
                      <div
                  ...
                  {/*Sexto elemento*/}
                  <div className="relative max-lg:order-6 h-full">
                      <div className="absolute"></div>
                      <div
                        className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] bg-sky-200">
                          <div className="px-8 pt-8 pb-6 sm:px-10 sm:pt-10 sm:pb-0">
