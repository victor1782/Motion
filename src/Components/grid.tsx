        ...
        <div className="bg-gray-50 py-24 sm:py-32">
            <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
                ...
                <p className="text-left leading-3 text-base/7 font-semibold dark:text-stone-400/80">
                    ...
                    LATAM AIRLINES</p>
                <p
                  className="text-left text-primary font-bold mt-2 max-w-lg text-4xl font-semibold tracking-tight text-balance text-gray-950">
                    Volamos por tí
                </p>
                <div
                  className="mt-8 pt-8 lg:pt-12 grid gap-4 sm:mt-8 lg:grid-cols-3 lg:grid-rows-2 border-t-2 border-gray-200">
                    ...
                    <div className="relative lg:row-span-2">
                        <div className="absolute inset-px rounded-lg bg-white lg:rounded-l-[2rem]"></div>
                        <div
                          className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] lg:rounded-l-[calc(2rem+1px)] bg-blue-200">
                            <div className="px-8 pt-8 pb-3 sm:px-10 sm:pt-10 sm:pb-0">
                                <p className="mt-2 text-lg font-medium tracking-tight text-gray-950 max-lg:text-center">
                                    Mobile friendly
                                </p>
