    ...
    return (
      <div className="bg-gray-50 py-24 sm:py-32">
          <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
              <p ref={yearRef} className="text-left text-base/7 font-semibold dark:text-stone-400/80">
                  <span className='text-primary'>Year: </span>
                  2025</p>
              <p ref={clientRef} className="text-left leading-3 text-base/7 font-semibold dark:text-stone-400/80">
